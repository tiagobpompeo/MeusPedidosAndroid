...
{
    public class HomeFragmentCellPopUp : Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Android.OS.Bundle savedInstanceState)
        {
            ...
            var view = inflater.Inflate(Resource.Layout.home_fragmentPopUp, null);
            ...
            if (!connection.IsSuccess)
            {
                ...
                if (catalogCached != null)
                {
                    if (catalogCached != null)
                    {
                        ...
                        list.Adapter = new CatalogoScreenAdapterPopUp(Activity, tableItems);
                    }
                }
            }
            else
